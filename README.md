...
- **Q6** : Quelles sont les pilotes ayant remporté le plus de victoire ? Faire un classement (Avec pandas et en python-base)
- **Q7** : Comment la vitesse moyenne a-t-elle évolué au fil des années
- **Q8** : Quels sont les pilotes les plus performants en 2023 ?
- **Q9** : Quels sont les pilotes et écuries les plus sujets aux abandons ?
- **Q10** : Peut-on prédire les performances d’un pilote à partir de ses résultats en course ?
...
- Lilian - Module Lilian.py, Notebook_final.ipyn(Q8, Q9, Q10, reg linéaire multiple pour la Q10) -[@LilianScicluna](https://github.com/LilianScicluna)
